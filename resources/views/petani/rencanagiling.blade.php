    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8 bg-white rounded-xl shadow-sm p-6 transition-all duration-300 hover:shadow-md">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Rencana Giling</h1>
                    <div class="flex items-center mt-2">
                        ...
                        <div>
                            <h2 class="text-lg font-semibold text-gray-800">{{ $pabrik->name }}</h2>
                            <p class="text-sm text-gray-500">Tahun {{ $tahunDipilih }}</p>
                        </div>
                    </div>
                </div>

                <form method="GET" action="{{ route('petani.rencanagiling', $pabrik->id) }}" class="flex items-center">
                    ...
                    <div class="relative">
                        <select id="tahun" name="tahun" onchange="this.form.submit()"
                                class="appearance-none bg-white border border-gray-300 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300">
                ...
                <div class="p-4 border-b">
                    <h3 class="font-semibold text-lg text-gray-800 flex justify-between items-center">
                        ...
                        @if(isset($dataPerBulan[$bulan]))
                            <span class="text-sm font-normal bg-blue-100 text-blue-800 px-2 py-1 rounded-full">
                ...
                <div class="p-4">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-gray-500 text-sm">Belum ada jadwal giling</p>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Detail Rencana Giling</h3>
                            <div class="mt-4 space-y-3">
                                ...
                                <div class="flex justify-between border-b pb-2">
                                    <span class="text-sm font-medium text-gray-500">Kebutuhan Giling</span>
                                    <span class="text-sm text-gray-900">{{ $item->kebutuhan_giling }}</span>
                                </div>
                                <div class="flex justify-between border-b pb-2">
