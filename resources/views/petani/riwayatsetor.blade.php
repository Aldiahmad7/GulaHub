...
<div class="container mx-auto px-4 pt-16 max-w-6xl">
    <h3 class="text-3xl font-semibold mb-8 mt-6 text-center text-gray-800">Riwayat Permintaan Pabrik</h3>

    <!-- Filter Tahun -->
    <form method="GET" action="{{ route('petani.riwayatsetor') }}" class="mb-6 flex mt-6 items-center space-x-4">
            ...
            <tbody>
                @forelse ($riwayat as $item)
                    <tr class="hover:bg-gray-50">
                        <td class="py-4 px-6 border-b border-gray-200">{{ $item->nama_pabrik }}</td>
