...
<div class="container mx-auto px-4 pt-16 max-w-5xl">
    <h2 class="text-3xl font-semibold mb-4 mt-6 text-center text-gray-800">Ajuan Saya ke Pabrik</h2>

    <!-- Filter Tahun -->
    <form method="GET" action="{{ route('petani.ajuan') }}" class="mb-6">
        ...
        <div class="overflow-x-auto shadow-md rounded-lg">
            <table class="min-w-full bg-white border border-gray-200">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="py-3 px-6 text-left text-gray-700 font-medium border-b">Nama Pabrik</th>
                ...
                <tbody>
                    @foreach ($ajuanSaya as $ajuan)
                        <tr class="hover:bg-gray-50">
                            <td class="py-4 px-6 border-b border-gray-200">{{ $ajuan->nama_pabrik }}</td>
